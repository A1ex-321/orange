                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <form class="contact-form" action="/">
                            ...
                            <input type="text" name="text" placeholder="Position Apply For " class="contact-input">
                            <input type="file" name="text" placeholder="No Chosen" class="contact-input">
                                        ...
                                        <div class="team-item style-2">
                                            <div class="team-item-inner">
                                                ...
                                                <div class="team-content">
                                                    <a href="team-single.html"><h5 class="member-name">Software Engineer(Backend Development) </h5></a>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="team-item style-2">
                                            <div class="team-item-inner">
                                                ...
                                                <div class="team-content">
                                                    <a href="team-single.html"><h5 class="member-name">Full Stack Developer</h5></a>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="team-item style-2">
                                            <div class="team-item-inner">
                                                ...
                                                <div class="team-content">
                                                    <a href="team-single.html"><h5 class="member-name">UI/UX Designer</h5></a>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="team-item style-2">
                                            <div class="team-item-inner">
                                                ...
                                                <div class="team-content">
                                                    <a href="team-single.html"><h5 class="member-name">Quality Assurance Engineer</h5></a>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="team-item style-2">
                                            <div class="team-item-inner">
                                                ...
                                                <div class="team-content">
                                                    <a href="team-single.html"><h5 class="member-name">DevOps Engineer</h5></a>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="team-item style-2">
                                            <div class="team-item-inner">
                                                ...
                                                <div class="team-content">
                                                    <a href="team-single.html"><h5 class="member-name">Software Architect</h5></a>
