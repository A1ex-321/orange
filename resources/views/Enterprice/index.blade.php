...
<div class="text-center"> <!-- Apply Bootstrap class for text centering -->
    <a class="btn circle btn-md btn-gradient wow fadeInUp" style="display: inline-block; margin-top:-129px;" href="{{ url('/product') }}">View All <i class="fas fa-angle-right"></i></a>
</div>
