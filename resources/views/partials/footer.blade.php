<style>
    ...
    .icon-row a {
        ...
        margin: auto;
        margin-right: 50px;
        /* Add some spacing between each icon and label */
    }
</style>
                    ...
                    <div class="footer-inner">
                        <div class="footer-content">
                            <div class="logo" style="display: flex;">
                                ...
                                <h5 style="margin-bottom: 25px;padding:10px">Orange<span style="color: #E84E0D;">Mega</span>Software</h5>
                            </div>
                            <div class="content">
                                <p>We believe in Simple Creative & Flexible Design Standards.</p>
                                   <h6>Address:</h6>
                                <p>#249,1st floor,2nd St,
