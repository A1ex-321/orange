                                    ...
                                    <form action="{{ route('blogsco-update', ['id' => $getRecord->id])}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select name="blog" class="form-control" id="selectOption" >
                                                    <option value="" disabled>Select an option</option>
                                                    <option value="0" {{ old('blog', $getRecord->is_blog) == 0 ? 'selected' : '' }}>Blog</option>
                                                    <option value="1" {{ old('blog', $getRecord->is_blog) == 1 ? 'selected' : '' }}>Update Blog</option>
                                                </select>
