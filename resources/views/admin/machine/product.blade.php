                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-sm-6">
                            <div class="float-sm-right">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#test" data-whatever="@mdo"><i class="fas fa-plus"></i> Add product</button>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Product</h5><p style="color:red;">*image 420*344.size with in 1.5MB</p>
            ...
            <div class="modal-body">
                <form action="{{ route('add-product') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="recipient-name" name="description" required value="{{ old('description') }}">
                        @error('description')
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick="return confirm('Are you sure you want to delete?')" href="{{url('admin/product/delete/'.$value->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="editForm" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="message-text" class="col-form-label">Price:</label>
                                                                <input type="text" class="form-control" id="6" name="description" required>
                                                            </div>
                                                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        $('.edit-btn').on('click', function() {
            var id = $(this).data('id');
            $('#editForm').attr('action', "{{ route('updateproduct', '') }}" + '/' + id);
            $.ajax({
                type: "GET",
