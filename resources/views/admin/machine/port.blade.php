                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-sm-6">
                            <div class="float-sm-right">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#test" data-whatever="@mdo"><i class="fas fa-plus"></i> Add portfolio</button>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add portfolio</h5><p style="color:red;">*image 400*400.size with in 1.5MB</p>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('add-port') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a onclick="return confirm('Are you sure you want to delete?')" href="{{url('admin/port/delete/'.$value->id)}}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
